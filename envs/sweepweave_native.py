...
class SweepweavePrimeEnv(BaseEnv):
    """Native wrapper around prime-environments sweepweave.load_environment()."""

    env_type = "sweepweave_prime"
    ...
    def reset(self) -> Tuple[str, Dict[str, Any]]:
        ...
        meta = {
            "task": "Generate valid Sweepweave storyworld JSON.",
            "state": state,
            "repo_path": self.repo_path,
            "source": "sweepweave_prime",
        }
